      ...
      context "multiple stealth needles, why not" do
        it "can copy an already copied stealth needle" do
          ...
          [card, another_stealth_needle].each do |c|
            ...
            expect(c.definition.primary_ability.declaration.declarations).to be_one
            expect(c.definition.primary_ability.declaration.declarations.first.key).to eq(:copy_ship)
